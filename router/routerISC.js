...
router.get("/agotados", async(req,res)=>{
  ...
  let qr = `SELECT COMMUNITY_PRODUCTOS_SYNC.CODPROD, COMMUNITY_PRODUCTOS_SYNC.DESPROD, COMMUNITY_PRODUCTOS_SYNC.COSTO, ISNULL(COMMUNITY_PRODUCTOS_SYNC.LASTSALE,'2019-01-01') AS LASTSALE, 
